# Generated by precisionFDA exporter (v1.0.3) on 2018-06-14 05:53:27 +0000
# The asset download links in this file are valid only for 24h.

# Exported app: gatk-haplotypecaller, revision: 11, authored by: adam.halstead
# https://precision.fda.gov/apps/app-F0fX4kQ0Jy6Qbj2G0jZ79V41
...
# Download app assets
RUN curl https://dl.dnanex.us/F/D/zZ5ZypG1Xvj8pgk9XXQg2By607V99Z167J7fPq4q/GATK-3.5.tar | tar xf - -C / --no-same-owner --no-same-permissions
RUN curl https://dl.dnanex.us/F/D/qPF92Q9q8FXx12KYPpPqQvXVB2Ff6G48zqp2fZ6g/grch37-fasta.tar.gz | tar xzf - -C / --no-same-owner --no-same-permissions
